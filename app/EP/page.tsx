...
import Headline from "@/components/EP/Headline";
import WhatisEP from "@/components/EP/WhatisEP";
import Whatisit from "@/components/EP/Whatisit";
//import Structure from "@/components/EP/Structure";
...
const LandingPage = () => {
  ...
  return (
    <div>
      <div className="max-w-screen flex min-h-screen flex-col items-center justify-center overflow-hidden bg-black px-4">
        <Image
    ...
    text-center font-silkscreen text-2xl font-extrabold text-[#F6E445] sm:mt-6 sm:flex sm:flex-col sm:text-3xl md:flex-row lg:flex lg:text-4xl"
        >
          <div>
            <span>I</span>
            <span>n</span>
