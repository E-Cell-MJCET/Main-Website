            ...
            >
              ...
              {step === 3 && (
                <div className="space-y-6">
                  ...
                  {isTeam ? (
                    <>
                      <div className="mt-8 hidden md:flex flex-col items-center gap-4 md:flex-row md:justify-around">
                        <button
                          type="button"
                          onClick={prevStep}
                      ...
                      <div className="mt-8 flex md:hidden flex-col items-center gap-4 md:flex-row md:justify-around">
                        ...
                        <Link
                          href="https://chat.whatsapp.com/DOViTi8NHvH0LnapNsznoX"
                          type="button"
                          className=" w-full text-center  space-x-2 rounded-lg bg-gray-700 px-6 py-3 font-silkscreen text-white transition-all hover:bg-gray-600"
                        >
                          Need Help ?
                        </Link>
                      </div>
              ...
              {step === 4 && (
                <div className="space-y-6">
                  ...
                  <>
                    <div className="mt-8 hidden md:flex center gap-4 md:flex-row md:justify-around">
                      <button
                        type="button"
                        onClick={prevStep}
                        className="flex items-center space-x-2 rounded-lg border-2 border-gray-600 bg-transparent px-6 py-3 font-silkscreen text-gray-300 transition-all hover:border-gray-500 hover:bg-gray-700"
