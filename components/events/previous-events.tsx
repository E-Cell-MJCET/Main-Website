...
const PreviousEvents = () => {
  const events = [
    ...
    },
    {
      ...
      date: 'February 12',
      description: 'A 90-minute program packed with insights on brand building. From domain ownership to effective marketing strategies. we have got you covered. No coding expertise required.',
    ...
    },
    {
      ...
      date: 'December 17',
      description: 'Hack Revolution, a 15-hour coding event by ACES in collaboration with CSI and E-Cell at MJCET, brings together teams of 4-6 for networking, skill-building, and a prize pool of ₹3,00,000, plus internship opportunities.',
    ...
    },
    {
      ...
      date: 'November 18',
      description: 'An interactive workshop, dive into App Development with Flutter! Discover the latest in mobile app technology as you learn to create your own Flutter app. Gain hands-on experience and boost your chances of winning the Hackathons ₹3,00,000 prize pool!',
    ...
    },
    {
      ...
      date: 'November 16',
      description: 'A thrilling 3-round event! Round 1 kicks off with PICTIONARY, where teams race to draw and guess brand logos. Round 2 features Battle of Facts, a showdown defending given brands. The surprise Round 3 offers cash prizes! Assemble your team of 2 or 4 for a chance to win from the ₹2000 prize pool.',
