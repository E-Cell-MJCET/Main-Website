...
const ProfileSummary = ({
  ...
  useEffect(() => {
    const loadProfileData = () => {
      ...
      const arrayDataItems: Array<{
        key: keyof ProfileSummaryData;
        storageKey: string;
      }> = [
  ...
  const collectAllImages = (
    data: Partial<ProfileSummaryData>,
    sessionId: string
  ) => {
    ...
    if (
      data.profileHeaderImage &&
      data.profileHeaderImage.startsWith("data:image")
    ) {
      images.push({
        ...
        type: "Header",
        intent:
          "This image appears at the top of your profile as your banner image",
      });
    }
    ...
    return (
      <div className="mt-6 rounded-lg bg-white p-4 shadow-sm">
        ...
        <p className="mb-4 text-sm text-gray-600">
          All images you`ve uploaded across different sections of your profile.
        </p>
          ...
          {galleryItems.map((item, index) => (
            ...
            >
              ...
              <div className="p-4">
                ...
                <p className="text-xs italic text-gray-600">{item.intent}</p>
              </div>
            </div>
          ))}
        </div>
    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-gray-900 p-4">
      ...
      >
        ...
        <p className="mb-8 text-center text-gray-600">
          Thank you for completing your profile! Below is a summary of all the
          information you`ve provided. Your personalized portfolio is now ready
          to be generated.
        </p>
        {loading ? (
          ...
          <div className="mb-6 rounded-lg bg-gray-50 p-6">
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              ...
              <div className="rounded-lg bg-white p-4 shadow-sm">
                    ...
                    <ul className="mt-1 list-inside">
                      ...
                      {profileData.contactInfo.phone && (
                        <li className="text-sm text-gray-700">
                          ...
                          {profileData.contactInfo.countryDialCode}{" "}
                          {profileData.contactInfo.phone}
                        </li>
                      )}
                    </ul>
                ...
                {profileData.socialProfiles &&
                  Object.keys(profileData.socialProfiles).length > 0 && (
                    <div className="mb-4">
                      <h4 className="text-md font-semibold text-gray-800">
                        Social Profiles
                      </h4>
                      <ul className="mt-1 list-inside">
                        {Object.entries(profileData.socialProfiles).map(
                          ([platform, url]) => {
                            if (!url) return null;
              ...
              <div className="rounded-lg bg-white p-4 shadow-sm">
                ...
                {renderArraySection(
                  "Featured Content",
                  profileData.featuredItems,
                  "title"
                )}
                {renderArraySection(
                  "Honors & Awards",
                  profileData.honorsAwards,
                  "title"
                )}
                {renderArraySection(
                  "Test Scores",
            ...
            {profileData.personalInfo?.about && (
              <div className="mt-6 rounded-lg bg-white p-4 shadow-sm">
                <h3 className="mb-2 text-lg font-bold text-teal-700">
                  About Me
                </h3>
        ...
        <p className="mb-8 text-center text-gray-600">
          You`re all set! Click `Complete` below to finalize your profile and
          continue to your personalized portfolio.
        </p>
        {/* Navigation Buttons */}
