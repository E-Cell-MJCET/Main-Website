...
const Step8Welcome = ({
  ...
  useEffect(() => {
    licenseFileInputRefs.current = licenseFileInputRefs.current.slice(
      0,
      licenses.length
    );
  }, [licenses.length]);
  ...
  useEffect(() => {
    certificationFileInputRefs.current =
      certificationFileInputRefs.current.slice(0, certifications.length);
      ...
      >
        ...
        {(licenses.some((l) => l.title || l.description || l.image) ||
          ...
          <div className="mb-6 rounded-lg border border-gray-200 bg-gray-50 p-4">
            ...
            {licenses.some((l) => l.title || l.description || l.image) && (
              <div className="mb-4">
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                  {licenses
                    .filter((l) => l.title || l.description || l.image)
                    .map((license, index) => (
                      <div
                        key={index}
            ...
            {certifications.some(
              (c) => c.title || c.description || c.image
            ) && (
              <div>
                <h4 className="text-md mb-2 font-medium text-gray-700">
                  Certifications
