...
const Step4Welcome = ({
  ...
  const industryOptions = ["Executive", "Governing Body"];
  ...
  const handleNext = async () => {
    ...
    // Only update database if userData exists and Profile_Data_Created is true
    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-gray-900 p-4">
      ...
      >
        ...
        {industryPreference === "Executive" && (
          <div className="mb-6">
            <h3 className="mb-3 text-lg font-medium text-gray-700">
              What`s Your Portfolio? <br /> (Make sure it`s accurate, as our
              systems constantly check for the same)
            </h3>
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        {industryPreference === "Governing Body" && (
          <div className="mb-6">
            <h3 className="mb-3 text-lg font-medium text-gray-700">
              What`s Your Governing Body Position? <br /> (Make sure it`s
              accurate, as our systems constantly check for the same)
            </h3>
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        <div className="mb-6">
          ...
          <p className="mb-4 text-sm text-gray-500">
            Add your social media profiles to connect with visitors. Leave blank
            any you don`t want to share.
          </p>
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-sm text-gray-500">
            Your location helps visitors connect with you and may be displayed
            on your profile.
          </p>
        </div>
        {/* Navigation Buttons */}
