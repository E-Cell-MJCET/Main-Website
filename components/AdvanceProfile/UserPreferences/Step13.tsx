...
const Step13Welcome = ({
  ...
  useEffect(() => {
    productFileInputRefs.current = productFileInputRefs.current.slice(
      0,
      products.length
    );
  }, [products.length]);
      ...
      >
        ...
        <div className="mb-8">
          ...
          <p className="mb-4 text-gray-600">
            Showcase products you`ve created or been involved in developing.
          </p>
              ...
              <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleProductChange(index, "productLink", e.target.value)
                    }
                    className="mb-2 w-full rounded-lg border border-gray-300 p-3 pl-10"
                  />
                </div>
        ...
        <div className="mb-8">
          ...
          <p className="mb-4 text-gray-600">
            Describe professional services you offer or specialize in.
          </p>
          {services.map((service, index) => (
            ...
            >
              ...
              <textarea
                ...
                onChange={(e) =>
                  handleServiceChange(index, "specialties", e.target.value)
                }
                className="mb-2 w-full rounded-lg border border-gray-300 p-3"
                rows={2}
              />
              <div className="relative">
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleServiceChange(index, "pricing", e.target.value)
                  }
                  className="mb-2 w-full rounded-lg border border-gray-300 p-3 pl-10"
                />
              </div>
        ...
        {(products.some((p) => p.name || p.description || p.image) ||
          ...
          <div className="mt-8">
            ...
            <div className="rounded-lg border border-gray-200 bg-gray-50 p-4">
              ...
              {products.some((p) => p.name || p.description || p.image) && (
                <div className="mb-6">
                  <h4 className="mb-3 text-lg font-medium text-emerald-700">
                    Products
                  </h4>
                  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    {products
                      .filter((p) => p.name || p.description || p.image)
                      .map((product, index) => (
                        <div
              ...
              {services.some((s) => s.name || s.description) && (
                <div>
                  <h4 className="mb-3 text-lg font-medium text-teal-700">
                    Services
                  </h4>
                  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    {services
