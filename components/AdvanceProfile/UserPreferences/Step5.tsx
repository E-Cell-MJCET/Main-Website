...
const Step5Welcome = ({
  ...
  const dateInputClass = "w-full rounded-lg border border-gray-300 p-3 focus:border-indigo-500 focus:ring-indigo-500";
  ...
  const toggleCurrentlyWorking = (index: number) => {
    if (currentlyWorkingIndices.includes(index)) {
      setCurrentlyWorkingIndices(currentlyWorkingIndices.filter(i => i !== index));
      ...
      // Set to "Present"
      const updatedExperiences = [...experiences];
      updatedExperiences[index] = { ...updatedExperiences[index], endDate: "Present" };
      setExperiences(updatedExperiences);
    }
  };
  ...
  const toggleCurrentlyStudying = (index: number) => {
    if (currentlyStudyingIndices.includes(index)) {
      setCurrentlyStudyingIndices(currentlyStudyingIndices.filter(i => i !== index));
      // Clear "Present" and allow date entry
      const updatedEducation = [...education];
      ...
      // Set to "Present"
      const updatedEducation = [...education];
      updatedEducation[index] = { ...updatedEducation[index], endDate: "Present" };
      setEducation(updatedEducation);
    }
  };
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center">
                      ...
                      />
                      <label htmlFor={`currently-working-${index}`} className="text-sm text-gray-700">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center">
                      <input
                        ...
                        className="mr-2 size-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"
                      />
                      <label htmlFor={`currently-studying-${index}`} className="text-sm text-gray-700">
