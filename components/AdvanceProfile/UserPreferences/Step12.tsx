      ...
      >
        ...
        <div className="mb-6">
          <p className="mb-4 text-center text-gray-600">
            Share the causes you`re passionate about to showcase your values and
              ...
              <div key={index} className="mb-4 rounded-lg border p-4 shadow-sm">
                <div className="mb-2 flex items-center justify-between">
                  <input
                    ...
                    value={item.title}
                    onChange={(e) =>
                      handleCauseChange(index, "title", e.target.value)
                    }
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    handleCauseChange(index, "description", e.target.value)
                  }
                  className="mb-2 w-full rounded-lg border border-gray-300 p-3"
                  rows={3}
                />
                <textarea
                  ...
                  value={item.support}
                  onChange={(e) =>
                    handleCauseChange(index, "support", e.target.value)
                  }
                  className="mb-2 w-full rounded-lg border border-gray-300 p-3"
                  rows={2}
                />
