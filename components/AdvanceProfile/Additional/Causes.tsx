...
import { getCausesThemeStyles } from "../Themes/CausesTheme";

// Match Step12 data structure exactly
type CauseContent = { title: string; description: string; support: string };
      ...
      <div className="container relative z-10 mx-auto max-w-6xl px-4">
        ...
        >
          ...
          <p className={`mx-auto max-w-2xl ${styles.mainDescription}`}>
            The social issues and causes I`m passionate about, reflecting my
            values and interests beyond professional work.
          </p>
        </motion.div>
        <motion.div
            ...
            >
              ...
              <div className="flex flex-1 flex-col p-6">
                <div className="mb-4 flex items-center">
                  {/* Heart Icon */}
                  <div
                    className={`mr-3 rounded-full ${styles.cardIconContainer} p-2`}
                  >
                    <svg
                      className={`size-5 ${styles.cardIcon}`}
                      viewBox="0 0 24 24"
                      fill="none"
                      xmlns="http://www.w3.org/2000/svg"
                    >
                      <path
                        d="M19.5 12.5725L12 20L4.5 12.5725C3.76139 11.8553 3.32857 10.8697 3.31112 9.83831C3.29367 8.80687 3.69249 7.80782 4.4069 7.06927C5.12132 6.33073 6.11386 5.9151 7.14406 5.91224C8.17427 5.90938 9.16904 6.31951 9.8895 7.054L12 9.1385L14.1105 7.054C14.831 6.31951 15.8257 5.90938 16.8559 5.91224C17.8861 5.9151 18.8787 6.33073 19.5931 7.06927C20.3075 7.80782 20.7063 8.80687 20.6889 9.83831C20.6714 10.8697 20.2386 11.8553 19.5 12.5725Z"
                        stroke="currentColor"
                        strokeWidth="2"
                        strokeLinecap="round"
                ...
                {cause.support && (
                  <div className={`mb-4 rounded-lg ${styles.supportBox} p-3`}>
                    <h4
                      className={`mb-1 text-xs font-semibold uppercase ${styles.supportTitle}`}
                    >
                      How I`ve Helped:
                    </h4>
                    <p
                      className={`line-clamp-2 text-sm italic ${styles.supportText}`}
                    >
                      {cause.support}
                    </p>
                  </div>
        ...
        {selectedCause && (
          ...
          >
            ...
            >
              ...
              {/* Cause Details */}
              <h3
                className={`mb-6 text-center text-2xl font-bold ${styles.modalTitle} md:text-3xl`}
              >
                {selectedCause.title}
              </h3>
              {/* Description */}
              <div className="mb-6">
                ...
                >
                  Why I`m Passionate About This Cause
                </h4>
                <div className={`rounded-lg ${styles.modalContentBox} p-4`}>
                  <p
                    className={`whitespace-pre-line ${styles.modalContentText}`}
                  >
