...
import { getVolunteerExperienceThemeStyles } from "../Themes/VolunteerExperTheme";

// Match Step15 data structure exactly
type VolunteerContent = { title: string; description: string };
          ...
          >
            ...
            >
              ...
              <div className="mb-6 flex justify-center">
                ...
                >
                  <svg
                    className={`size-12 ${styles.modalIconColor}`}
                    viewBox="0 0 24 24"
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                  >
              ...
              {/* Volunteer Details */}
              <h3
                className={`mb-4 text-center text-2xl font-bold ${styles.modalTitle} md:text-3xl`}
              >
              ...
              <div className={`rounded-lg p-4 ${styles.modalDescriptionBox}`}>
                ...
                <p
                  className={`whitespace-pre-line ${styles.modalDescriptionText}`}
                >
                  {selectedItem.description ||
                    "No detailed description available for this volunteer experience."}
                </p>
              </div>
            </motion.div>
          </motion.div>
