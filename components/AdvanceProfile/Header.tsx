...
const Header: React.FC<{ userData: UserData }> = ({ userData }) => {
  ...
  const profileImage = userData.ProfileImageHeader || "/assets/Team/Execom/Technical/Adnan/trial_logo.jpg";
  ...
  const completeUserData: UserData = {
    ...
    selectedSections: Array.isArray(userData.selectedSections) ? userData.selectedSections : [],
  ...
  return (
    <div className="flex min-h-screen w-full flex-col items-center justify-center overflow-x-hidden bg-gradient-to-r from-black to-teal-900 p-6 text-white md:flex-row md:items-center md:justify-between">
      ...
      {/* Contact Info Popup */}
      <Popup isOpen={isPopupOpen} onClose={closePopup} contact_info={formattedContactInfo} />
