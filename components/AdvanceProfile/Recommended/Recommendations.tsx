...
import {
  RecommendationsThemeStyles,
  recommendationsThemeMap,
} from "../Themes/RecommendationTheme";

// Match Step9 data structure exactly
type Recommendation = { title: string; description: string; link: string };
...
export function RecommendationsAlternative({
  recommendations = [],
  theme = "Default",
}: RecommendationsProps) {
  // Early return if no recommendations
