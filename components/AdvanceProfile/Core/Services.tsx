...
import { getServicesThemeStyles } from "../Themes/Services.Theme";
        ...
        {services.length === 0 ? (
          ...
          >
            {services.map((service, index) => (
              ...
              >
                {/* Service Icon */}
                <div className={`flex h-32 items-center justify-center ${styles.cardIconContainer}`}>
                  <svg className={`size-16 ${styles.cardIcon}`} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="flex flex-1 flex-col p-6">
                  <div className="flex items-center justify-between">
                    ...
                    {/* Price Badge */}
                    <span className={`rounded-full ${styles.priceBadge} px-3 py-1 text-xs font-semibold ${styles.priceBadgeText}`}>
                      {service.pricing}
                    </span>
                  </div>
          ...
          >
            ...
            >
              ...
              <div className="mb-4 flex items-center justify-between">
                ...
                <span className={`rounded-lg ${styles.modalPriceBadge} px-4 py-1 text-base font-bold ${styles.modalPriceText}`}>
              ...
              {/* Specialties */}
              <div className="mb-8">
                <h4 className={`mb-2 text-sm font-semibold uppercase tracking-wider ${styles.modalSectionTitle}`}>Specialties</h4>
                <div className={`rounded-lg ${styles.modalSpecialtiesBox} p-4`}>
                  <p className={`whitespace-pre-line ${styles.modalSpecialties}`}>
