...
export interface CausesThemeStyles {
  ...
  export const causesThemeMap: Record<string, CausesThemeStyles> = {
    ...
    "Default": {
      container: "relative py-16",
      backgroundGradient: "bg-gradient-to-b from-emerald-950 via-teal-900 to-emerald-950",
      decorativeElement1: "bg-emerald-500 opacity-10 blur-3xl",
      decorativeElement2: "bg-teal-400 opacity-10 blur-3xl",
      mainHeading: "bg-gradient-to-r from-emerald-400 to-teal-300 bg-clip-text text-transparent",
      mainDescription: "text-teal-200",
      emptyContainer: "bg-emerald-900/50 backdrop-blur-sm border border-teal-500/10",
      emptyText: "text-teal-200",
      cardContainer: "grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3",
      card: "bg-gradient-to-br from-emerald-900/70 to-teal-950/70 backdrop-blur-sm border border-teal-500/10 transition-all duration-300",
      cardIconContainer: "bg-emerald-500/20",
      cardIcon: "text-teal-300",
      cardTitle: "text-white",
      cardTitleHover: "group-hover:text-teal-300",
      cardDescription: "text-teal-200",
      supportBox: "bg-emerald-950/50 border border-teal-500/10",
      supportTitle: "text-teal-300",
      supportText: "text-teal-100",
      actionButton: "bg-gradient-to-r from-emerald-600 to-teal-600 text-white transition-all duration-300",
      actionButtonHover: "hover:from-emerald-700 hover:to-teal-700",
      modalOverlay: "bg-emerald-950 bg-opacity-75 backdrop-blur-sm",
      modalContainer: "bg-gradient-to-b from-emerald-900 to-teal-950 border border-teal-500/10",
      modalIconContainer: "bg-emerald-500/20",
      modalIcon: "text-teal-300",
      modalTitle: "text-white",
      modalSectionTitle: "text-teal-300",
      modalContentBox: "bg-emerald-950/50 border border-teal-500/10",
      modalContentText: "text-teal-100",
      modalCalloutText: "text-teal-200",
      modalCtaButton: "bg-gradient-to-r from-emerald-600 to-teal-600 text-white transition-all duration-300",
      modalCtaButtonHover: "hover:from-emerald-700 hover:to-teal-700",
      closeButton: "bg-emerald-700 bg-opacity-50 text-white transition-all duration-300",
      closeButtonHover: "hover:bg-opacity-70"
    }
  };
