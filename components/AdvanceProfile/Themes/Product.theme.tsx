...
export interface ProductThemeStyles {
  ...
  export const productThemeMap: Record<string, ProductThemeStyles> = {
    ...
    "Default": {
      ...
      cardImageOverlay: "bg-gradient-to-t from-blue-900 to-transparent",
      cardPlaceholderBg: "bg-gradient-to-r from-blue-700 to-blue-900",
      cardPlaceholderIcon: "text-blue-300",
      cardPriceTag: "bg-yellow-300",
      cardPriceText: "text-blue-900",
      cardTitle: "text-white",
      cardTitleHover: "group-hover:text-yellow-300",
      cardDescription: "text-blue-200",
      detailsButton: "bg-blue-600/20 text-blue-300 hover:bg-blue-600/40",
      detailsButtonHover: "hover:bg-blue-600/40",
      purchaseButton: "bg-gradient-to-r from-blue-600 to-yellow-600 text-white",
      purchaseButtonHover: "hover:from-blue-700 hover:to-yellow-700",
      modalOverlay: "bg-black bg-opacity-75 backdrop-blur-sm",
      modalContainer: "bg-gradient-to-b from-blue-900 to-blue-950",
      modalPlaceholderBg: "bg-gradient-to-r from-blue-700 to-blue-900",
      modalPlaceholderIcon: "text-blue-300",
      modalTitle: "text-white",
      modalPrice: "bg-yellow-300",
      modalPriceText: "text-blue-900",
      modalSectionTitle: "text-yellow-300",
      modalDescription: "text-blue-100",
      modalFeaturesBox: "bg-blue-950/50",
      modalFeatures: "text-blue-100",
      modalPurchaseButton: "bg-gradient-to-r from-blue-600 to-yellow-600 text-white",
      modalPurchaseButtonHover: "hover:from-blue-700 hover:to-yellow-700",
      closeButton: "bg-blue-700 bg-opacity-50 text-white",
      closeButtonHover: "hover:bg-opacity-70"
    }
  };
