// Define theme information types for Recommendations component
export interface RecommendationsThemeStyles {
    container: string;
...
export const recommendationsThemeMap: Record<string, RecommendationsThemeStyles> = {
    "Gradient Theme": {
        container: "relative min-h-screen bg-gradient-to-b from-gray-900 to-black pt-16",
        backgroundGlow1: "absolute left-1/4 top-20 size-64 rounded-full bg-purple-600 opacity-5 blur-3xl",
        backgroundGlow2: "absolute right-1/4 top-60 size-80 rounded-full bg-blue-500 opacity-5 blur-3xl",
        heading: "mb-4 bg-gradient-to-r from-purple-400 to-blue-500 bg-clip-text text-4xl font-bold text-transparent md:text-5xl",
    ...
    "Monochromatic Theme": {
        container: "relative min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 pt-16",
    ...
    "Dark Theme with accent colors": {
        container: "relative min-h-screen bg-black pt-16",
    ...
    "Default": {
        container: "relative min-h-screen bg-gradient-to-b from-black to-gray-900 pt-16",
