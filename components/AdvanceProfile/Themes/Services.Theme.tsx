...
export interface ServicesThemeStyles {
  ...
  export const servicesThemeMap: Record<string, ServicesThemeStyles> = {
    ...
    "Default": {
      container: "relative py-16",
      backgroundGradient: "bg-gradient-to-b from-cyan-900 via-cyan-800 to-cyan-950",
      decorativeElement1: "bg-teal-500 opacity-10 blur-3xl",
      decorativeElement2: "bg-blue-500 opacity-10 blur-3xl",
      mainHeading: "bg-gradient-to-r from-teal-400 to-cyan-400 bg-clip-text text-transparent",
      mainDescription: "text-cyan-200",
      emptyContainer: "bg-cyan-800/50",
      emptyText: "text-cyan-200",
      cardContainer: "grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3",
      card: "bg-gradient-to-br from-cyan-800/70 to-cyan-950/70",
      cardIconContainer: "bg-gradient-to-r from-cyan-700/30 to-teal-700/30",
      cardIcon: "text-cyan-300",
      cardTitle: "text-white",
      cardTitleHover: "group-hover:text-cyan-300",
      priceBadge: "bg-teal-500/20",
      priceBadgeText: "text-teal-300",
      cardDescription: "text-cyan-200",
      detailsButton: "bg-gradient-to-r from-teal-600 to-cyan-600 text-white",
      detailsButtonHover: "hover:from-teal-700 hover:to-cyan-700",
      modalOverlay: "bg-black bg-opacity-75 backdrop-blur-sm",
      modalContainer: "bg-gradient-to-b from-cyan-900 to-cyan-950",
      modalIconContainer: "bg-teal-500/20",
      modalIcon: "text-teal-400",
      modalTitle: "text-white",
      modalPriceBadge: "bg-gradient-to-r from-teal-500 to-cyan-500",
      modalPriceText: "text-white",
      modalSectionTitle: "text-teal-300",
      modalDescription: "text-cyan-100",
      modalSpecialtiesBox: "bg-cyan-950/50",
      modalSpecialties: "text-cyan-100",
      modalInquireButton: "bg-gradient-to-r from-teal-600 to-cyan-600 text-white",
      modalInquireButtonHover: "hover:from-teal-700 hover:to-cyan-700",
      closeButton: "bg-cyan-700 bg-opacity-50 text-white",
      closeButtonHover: "hover:bg-opacity-70"
    }
  };
