...
const ThemePreview: React.FC<ThemePreviewProps> = ({ theme, isSelected }) => {
  ...
  return (
    <div
      className={`relative rounded-lg ${isSelected ? "ring-2 ring-indigo-600" : ""}`}
    >
      {renderPreview()}
      {isSelected && (
...
function Profile_Themes({ userId }: { userId: string }) {
      ...
      <div className="mb-6">
        ...
        <div className="rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-700">
          ...
          <p className="mt-2 text-xs text-gray-500 dark:text-gray-400">
            Our design team will review your preferences and apply them to your
            profile theme.
          </p>
        </div>
      </div>
