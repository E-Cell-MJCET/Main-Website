...
function Events() {
  ...
  const [newEvent, setNewEvent] = useState<EventFormData>({ title: '', date: '', description: '' });
        ...
        <div className="mb-6 rounded-lg border border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-gray-800">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="mt-1 text-gray-600 dark:text-gray-300">Manage and view all E-Cell events here.</p>
            </div>
            {isGoverningBody && (
              <button
                onClick={() => {
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
            {events.map((event) => (
              ...
              >
                <div className="p-5">
                  <h3 className="mb-2 text-xl font-semibold text-gray-800 dark:text-white">{event.title}</h3>
