      ...
      <div className={`relative overflow-hidden rounded-2xl ${bgColor} transition-all duration-500 ease-out group-hover:scale-[1.02]`}>
        ...
        <div className="absolute inset-x-0 bottom-0 translate-y-2 p-6 transition-transform duration-500 group-hover:translate-y-0">
          <div className="rounded-xl border border-white/10 bg-black/80 p-4 backdrop-blur-sm">
            ...
            <p className="text-sm uppercase tracking-wider text-gray-300">{role}</p>
          </div>
        </div>
      </div>
    </div>
...
const members = [
  {
    ...
    imageUrl: "https://www.ecellmjcet.com/_next/static/media/shuja.14a55a50.jpeg",
  ...
  },
  {
    name: "Ayesha Fatima",
    role: "Chief Coordinator",
    imageUrl: "https://www.ecellmjcet.com/_next/static/media/ayesha.c6f56b51.jpeg",
  ...
  },
  {
    ...
    imageUrl: "https://www.ecellmjcet.com/_next/static/media/irfan.1892d566.jpeg",
  ...
  },
  {
    ...
    imageUrl: "https://www.ecellmjcet.com/_next/static/media/maliha.dfb68e47.jpeg",
